...
$S$ が小さいほど消費者はブランドを切り替え、大きいほど同じブランドを繰り返し選ぶ。
...
式から自明だが、シェアが低いブランドほどリフトが大きくなっている。例えばMfr_2は市場シェアは 2.6% にすぎないが、繰り返し購買確率は 21.5%——ランダム選択の 8.4 倍——であり、他の流入が少ない分ロイヤルティが高いという構造を示している。
...
また、このモデルからは $S$ という1つの数値でカテゴリ全体のロイヤルティを要約でき、パラメータが推定できれば「次の購買がどうなるか」のシミュレーションも可能になる。
